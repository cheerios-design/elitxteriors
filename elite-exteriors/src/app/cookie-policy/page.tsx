      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6">
            ...
            experience by remembering your preferences and improving website
            functionality.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              <strong>Google Maps:</strong> For location services and directions
            </li>
            <li>
          ...
          <p className="mb-6">
            While you can browse our website with cookies disabled, please note
            that some features and functionality may not work properly,
            including:
          </p>
          <ul className="list-disc pl-6 mb-6">
          ...
          <ul className="list-disc pl-6 mb-6">
            ...
            <li>
              <strong>Analytics cookies:</strong> Usually expire after 1-2 years
            </li>
          </ul>
